    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        try {
            ...
            case COLUMN:
                ...
                salt = queryResults[1]; //get salt from database table
                break;
            case EXTERNAL:
                password = getPasswordForUser(conn, username)[0];
                salt = getSaltForUser(username); //get salt by username
            }
            ...
            info = new SimpleAuthenticationInfo(username, password.toCharArray(), getName()); //form AuthenticationInfo
            ...
            final String message = "There was a SQL error while authenticating user1 [" + username + "]";
